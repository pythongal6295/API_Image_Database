...
def picture_id(user_id, picture_table):
    ...
    '''
    return lui.picture_id(user_id, picture_table)

def add_picture(user_id, tags, picture_id, picture_collection, user_collection):
    '''
...
def save_picture(user_id, picture_id, indiv_tags, my_basedir, picture_collection):
    '''
...
def list_user_images(user_id, my_basedir):
    ...
    if os.listdir(user_id_dir):
        ...
        tpl_lst_full = lui.list_user_images(user_id, user_id_dir, user_id_lst, tpl_lst)
        return tpl_lst_full
    else:
...
def reconcile_images(user_id, tpl_lst, picture_table):
    return lui.reconcile_images(user_id, tpl_lst, picture_table)
